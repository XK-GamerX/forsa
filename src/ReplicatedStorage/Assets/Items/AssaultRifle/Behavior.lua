...
v0.Activated = function(v23) --[[ Line: 164 ]] --[[ Name: Activated ]]
    ...
    if v5 then
        ...
        while true do
            if v23.Item.Parent and v23.Shooting then
                if (tonumber(v23.TimeSinceLastShot) or 0) + 1 / (v23.Config.RPM / 60) >= tick() then
                    task.wait();
                elseif v23.Ammo.Value <= 0 then
                    v23.Shooting = false;
                    return;
                else
                    if v23.Config.SemiAuto then
                        v23.Shooting = false;
                    end;
                    v23.TimeSinceLastShot = tick();
                    v2:Play(v23.Config.Sounds.Shoot, {
                        Parent = v23.Item.ItemRoot, 
                        Volume = 0.3, 
                        PlaybackSpeed = Random.new():NextNumber(0.985, 1.015)
                    });
            ...
            elseif v23.Ammo.Value <= 0 and v23.ReservedAmmo.Value > 0 and not v23.ReloadingThread then
                v2:Play(v23.Config.Sounds.Reloading, {
                    Parent = v23.Item.ItemRoot
                });
                v23.Communicator:FireClient(v23.Player, "Reloading");
                v23.ReloadingThread = task.delay(v23.Config.ReloadTime, function() --[[ Line: 231 ]]
                    -- upvalues: v23 (copy)
...
v0.Deactivated = function(v36) --[[ Line: 241 ]] --[[ Name: Deactivated ]]
    v36.Shooting = nil;
end;
return v0;