...
return {
	...
	StabDamage = 25, 
	StabCooldown = 2, 
	StunTimeAfterLosingStamina = 1.25, 
	SpeedTimeAfterStaminaLossStun = 2, 
	StardrivenTokenData = {
		[2] = {
			Distance = 75, 
			Lifetime = 0.4, 
	...
	StardrivenHallucinationDuration = 7, 
	StardrivenCooldown = 15, 
	ImplantBaseDamage = 55, 
	ImplantBombThrowBaseRange = 30, 
	ImplantKnockback = 2, 
	ImplantCooldown = 15, 
	ImplantDecayTime = 30, 
	...
	Animations = {
		...
		StardrivenTendrilStart = "rbxassetid://88978743873591", 
		...
		ImplantDash = "rbxassetid://122864741518365", 
