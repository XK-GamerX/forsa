...
v0.Abilities = {
            ...
            if game["Run Service"]:IsServer() then
                ...
                task.delay(0.83, function() --[[ Line: 26 ]]
                    ...
                    local _ = v3:CreateHitbox(v5.Player, {
                        ...
                        RagdollOnHit = true, 
                        Connections = {
                            Hit = function(_) --[[ Line: 39 ]] --[[ Name: Hit ]]
                            ...
                            Ended = function() --[[ Line: 43 ]] --[[ Name: Ended ]]
                ...
                task.delay(1.25, function() --[[ Line: 51 ]]
                ...
                if game["Run Service"]:IsClient() then
                    ...
                    v1:Play(v5.Config.Sounds.Introduction, {
                        Parent = v5.Rig.PrimaryPart
                    });
                    local v9 = tick();
                    ...
                    game["Run Service"]:BindToRenderStep("StrongLeft", Enum.RenderPriority.Character.Value + 1, function() --[[ Line: 66 ]]
    ...
    Stomp = {
        ...
        Cooldown = 5, 
        Callback = function(v12) --[[ Line: 83 ]] --[[ Name: Callback ]]
            -- upvalues: v2 (copy), v1 (copy), v3 (copy)
            if game["Run Service"]:IsServer() then
                ...
                v1:Play(v12.Config.Sounds.StrongLeftBuild, {
                    Parent = v12.Rig.PrimaryPart
                });
                task.delay(0.333, function() --[[ Line: 95 ]]
                    -- upvalues: v2 (ref), v12 (copy), v1 (ref), v3 (ref)
                    ...
                    v1:Play(v12.Config.Sounds.StompSound, {
                        Parent = v12.Rig.PrimaryPart
                    });
                    ...
                    v3:CreateHitbox(v12.Player, {
                        ...
                        Connections = {
                            Hit = function(v17) --[[ Line: 119 ]] --[[ Name: Hit ]]
                ...
                task.delay(2, function() --[[ Line: 128 ]]
                    -- upvalues: v12 (copy)
    ...
    AeroSpear = {
        ...
        Cooldown = 5, 
        Callback = function(v18) --[[ Line: 145 ]] --[[ Name: Callback ]]
            ...
            if game["Run Service"]:IsServer() then
                ...
                task.delay(0.8, function() --[[ Line: 156 ]]
                    ...
                    v3:CreateHitbox(v18.Player, {
                        Size = Vector3.new(3, 3, 3, 0), 
                        CFrame = function() --[[ Line: 168 ]] --[[ Name: CFrame ]]
                            -- upvalues: v22 (copy)
                            return v22.CFrame;
                        end, 
                        ...
                        PredictVelocity = false, 
                        Connections = {
                            Hit = function(v23) --[[ Line: 178 ]] --[[ Name: Hit ]]
                ...
                task.delay(2, function() --[[ Line: 187 ]]
                    -- upvalues: v18 (copy)
    ...
    Attack = {
        ...
        Cooldown = 0.1, 
        Callback = function(v24) --[[ Line: 204 ]] --[[ Name: Callback ]]
            -- upvalues: v1 (copy), v3 (copy)
            if game["Run Service"]:IsServer() then
                v24.AbilitiesDisabled = true;
                v1:Play(v24.Config.Sounds.Swing, {
                    Parent = v24.Rig.PrimaryPart, 
                    PlaybackSpeed = Random.new():NextNumber(0.975, 1.025), 
                    Volume = 1
                });
                task.delay(0.1, function() --[[ Line: 211 ]]
                    -- upvalues: v3 (ref), v24 (copy), v1 (ref)
                    local _ = v3:CreateHitbox(v24.Player, {
                        ...
                        HitMultiple = false, 
                        Connections = {
                            Hit = function(_) --[[ Line: 222 ]] --[[ Name: Hit ]]
                                -- upvalues: v1 (ref), v24 (ref)
                                v1:Play(v24.Config.Sounds.Hit, {
                                    Parent = v24.Rig.PrimaryPart, 
                                    PlaybackSpeed = Random.new():NextNumber(0.975, 1.025), 
                                    Volume = 0.25
                                });
...
v0.OnIntroduction = function(_, _, v29, v30) --[[ Line: 247 ]] --[[ Name: OnIntroduction ]]
    ...
    local v32 = nil;
    task.delay(0.5, function() --[[ Line: 256 ]]
        -- upvalues: v32 (ref)
    ...
    task.delay(1.5, function() --[[ Line: 261 ]]
...
v0.OnVictory = function(_, v35, _, v37, _) --[[ Line: 269 ]] --[[ Name: OnVictory ]]
    if v35 == "Start" then
...
v0.OnExecution = function(_, v42, v43) --[[ Line: 284 ]] --[[ Name: OnExecution ]]
    ...
    task.delay(2.25, function() --[[ Line: 294 ]]
        -- upvalues: v43 (copy)
