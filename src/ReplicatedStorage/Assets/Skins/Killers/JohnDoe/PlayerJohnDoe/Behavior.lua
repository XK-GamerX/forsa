...
return {
    GetRig = function(_, v1) --[[ Line: 4 ]] --[[ Name: GetRig ]]
        ...
        pcall(function() --[[ Line: 11 ]]
            ...
            v2["Right Arm"].Transparency = 1;
            v1.Config.SpikeNumbersColor = l_HumanoidDescriptionFromUserId_0.TorsoColor;
            v2.Head.Glare.Color = l_HumanoidDescriptionFromUserId_0.TorsoColor;
