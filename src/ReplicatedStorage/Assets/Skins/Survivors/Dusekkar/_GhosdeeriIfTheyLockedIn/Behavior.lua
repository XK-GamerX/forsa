                    ...
                    local _ = v4:CreateHitbox(v77.Player, {
                        ...
                        Connections = {
                            Hit = function(v84) --[[ Line: 390 ]] --[[ Name: Hit ]]
                                -- upvalues: v80 (ref), v5 (ref), v77 (ref), v8 (ref), v30 (ref), v81 (ref)
...
v0.Created = function(_, v91) --[[ Line: 438 ]] --[[ Name: Created ]]
    -- upvalues: v3 (copy), v1 (copy), v22 (copy), v9 (copy)
    if game["Run Service"]:IsServer() then
        v3:SetConnection(("%*DusekkarCancel"):format((tostring(v91.Player))), "REMOTE_EVENT", function(v92) --[[ Line: 441 ]]
            -- upvalues: v91 (copy)
        ...
        if game["Run Service"]:IsClient() then
            if v91.Player == game.Players.LocalPlayer then
                v3:SetConnection(("%*DusekkarGet"):format((tostring(v91.Player))), "REMOTE_FUNCTION", function() --[[ Line: 450 ]]
            ...
            v3:SetConnection(("%*DusekkarReplZap"):format((tostring(v91.Player))), "REMOTE_EVENT", function(v102, v103) --[[ Line: 469 ]]
                ...
                v104:Add(v113);
                v113:Start();
                v113:BindToRenderStep("ExplosionShake", Enum.RenderPriority.Last.Value, function(v114, v115, _) --[[ Line: 519 ]]
...
v0.Destroyed = function(_, v122) --[[ Line: 544 ]] --[[ Name: Destroyed ]]
    -- upvalues: v3 (copy)
    if game["Run Service"]:IsServer() then
